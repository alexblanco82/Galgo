                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Flexible(
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '2oa6iues' /* 187 Ferndale Rd, Brixton */,
                                          ),
                                          maxLines: 1,
                                          style: FlutterFlowTheme.of(context)
                                              .titleMedium
                                                  ...
                                                  Flexible(
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'lmtz5uzv' /* Food, groceries, drinks, etc. */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: InkWell(
                                        ...
                                        highlightColor: Colors.transparent,
                                        onTap: () async {
                                          context.pushNamed('SpecialityFoods');
                                        },
                                        child: Container(
                                          decoration: BoxDecoration(),
                                          child: Column(
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '21eenspb' /* Peri Peri Near Me, Brixton */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelLarge
