...
const kUserKey = "YjI2ZDVjMzItNjQ3OS00YmFiLWFkMzgtZTFjNzZjNjg4OWVi";
const kAPIKey = "ZWI0MDc1NmQtZDY5ZC00NWQ1LThhMGYtNGFlYzgwMDc5YTYw";
...
exports.addUser = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    const createdUser = await client.createUser(
      "589a0a6c-b475-40ef-bb8c-8ddbfa230c88",
      user,
    );
